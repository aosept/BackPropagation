...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    SVFunctionViewController* vc1 = [SVFunctionViewController new];
    vc1.title = NSLocalizedString(@"Stock",nil);
    
    self.nc1 = [[UINavigationController alloc] initWithRootViewController:vc1];
    self.nc1.tabBarItem.image = [UIImage imageNamed:@"today"];
    

    NSMutableArray* vclist = [NSMutableArray new];

    [vclist addObject:self.nc1];
    
    
   
    self.nc1.tabBarController.tabBar.hidden = NO;
